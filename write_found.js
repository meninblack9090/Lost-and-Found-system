...
const filePath = path.join(__dirname, 'lost-and-found-mobile/src/screens/ReportFoundScreen.js');
...
console.log('File written successfully. Size:', fs.statSync(filePath).size);